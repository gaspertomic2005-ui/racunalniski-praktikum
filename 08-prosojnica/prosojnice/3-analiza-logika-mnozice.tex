\begin{frame}{Logika in množice}
	\begin{enumerate}
		...
		\item 
		Definiramo množici $A = [2,5]$ in $B = \{1,2,3,4\ldots\}$.
		V ravnino nariši:
		\begin{enumerate}
		   \item [2.1] $A \cap B \times \emptyset$
		   \item [2.2] $(A \cup B)^c \times \mathbb{R}$
		\end{enumerate}
		\item
		Dokaži:
		\begin{itemize}
...
\begin{frame}{Analiza}
	\begin{enumerate}
		\item
		Pokaži, da je funkcija $x \longmapsto \sqrt{x}$ enakomerno zvezna na $[0,\infty)$.
		\item 
